...
router.get('/', function (req, res) { 
    res.render('index', { title: 'Restaurent App', user : req.user }); 
}); 
 
router.get('/register', function(req, res) { 
    res.render('register', { title: 'Restaurent App Registration'}); 
}); 
...
router.get('/login', function(req, res) { 
    res.render('login', { title: 'Restaurent App Login', user : req.user }); 
}); 
